...
void main() async {
  ...
  group("Test Dashbaord Module API Endpoints", () {
    ...
    test("test mark attendance api check in ", () async {
      ...
      when(client.post(headers: {
        "x-woloo-token":
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTUyLCJyb2xlX2lkIjoxLCJpYXQiOjE3MzU4OTA0ODIsImV4cCI6MTczNjQ5NTI4Mn0.Uy90XgSfIlOyaPqDrxCkdbgV2grzHHaEKiG5FVNpRXE"
      }, body: {
        "type": "check_in",
        "location": [19.0760, 72.8777],
      }, Uri.parse(APIConstants.BASE_URL + APIConstants.ATTENDANCE)))
          .thenAnswer((_) async => http.Response(
              '{ "message": type is not allowed to be empty", "success": false,  "results": [] }',
              404));
    ...
    test("test mark attendance api check in expction ", () async {
      ...
      when(client.post(headers: {
        "x-woloo-token":
            "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NDE2LCJyb2xlX2lkIjoxLCJpYXQiOjE3MzA4MDc5MzIsImV4cCI6MTczMTQxMjczMn0.cxN_JTM5VPmufui4DLFz2WcDfXmM9-HibkBgEJZpOfk"
      }, body: {
        "type": "",
        "location": [19.0760, 72.8777],
      }, Uri.parse(APIConstants.BASE_URL + APIConstants.ATTENDANCE)))
    ...
    test("test mark attendance api check out ", () async {
      ...
      when(client.post(headers: {
        ...
        "location": [19.0760, 72.8777],
          ...
          .thenAnswer((_) async => http.Response(
              ' {"results":{"message":"Janitor checked_out successfully","attendance":{"last_attendance":{"time":"2024-11-06T10:31:10.009Z","type":"check_out","location":[19,20]},"last_attendance_date":"2024-11-05T23:30:39.421Z"}},"success":true} ',
              200));
    ...
    test("test on app load api ", () async {
      final client = MockClient();
      when(client
              .post(Uri.parse(APIConstants.BASE_URL + APIConstants.APP_LAUNCH)))
          .thenAnswer((_) async => http.Response(
              '  "results": {  "last_attendance": "check_in",  "last_attendance_date": "2024-11-05T23:30:39.421Z" },"success": true',
              200));
    ...
    test("test on app load api exception ", () async {
      ...
      try {
        await dashboardService.appLaunch(token: "");
      } catch (e) {
        expect(e.toString(), 'Exception: Failed to Mark attendace');
      }
    });
    ...
    test("test janitor list api ", () async {
      ...
      when(client.get(
          ...
          .thenAnswer((_) async => http.Response(
              ' {"results":[{"task_allocation_id":54190,"date":"06-11-2024","janitor_id":416,"request_type":"Regular","issue_description":null,"start_time":"04:00 AM","end_time":"07:00 AM","facility_id":474,"template_id":230,"template_name":"TemplateFloor","task_description":"Daily tasks","facility_name":"FacilityDustingFloors","estimated_time":120,"total_tasks":2,"booths":10,"floor_number":2,"location":"LocationHadpsar","lat":19.076,"lng":72.8777,"block_name":"BuildingBeta","pending_tasks":"0","status":"Request for closure"}],"success":true} ',
              200));

      var response =
          await dashboardService.getTasksByJanitorId(token: mockToken);
    ...
    test("test janitor list api exception ", () async {
      ...
      when(client.get(
              Uri.parse(APIConstants.BASE_URL + APIConstants.JANITOR_LIST)))
          .thenAnswer((_) async => http.Response(
              '{message: Forbidden, success: false, result: []}', 200));

      try {
        await dashboardService.getTasksByJanitorId();
      } catch (e) {
        expect(
            e.toString(), '{message: Forbidden, success: false, result: []}');
      }
    });
    ...
    test("test janitor Attendance History ", () async {
      ...
      when(client.get(Uri.parse(
              APIConstants.BASE_URL + APIConstants.ATTENDANCE_HISTORY_LIST)))
          .thenAnswer((_) async => http.Response(
              ' {"results":[{"task_allocation_id":54190,"date":"06-11-2024","janitor_id":416,"request_type":"Regular","issue_description":null,"start_time":"04:00 AM","end_time":"07:00 AM","facility_id":474,"template_id":230,"template_name":"TemplateFloor","task_description":"Daily tasks","facility_name":"FacilityDustingFloors","estimated_time":120,"total_tasks":2,"booths":10,"floor_number":2,"location":"LocationHadpsar","lat":19.076,"lng":72.8777,"block_name":"BuildingBeta","pending_tasks":"0","status":"Request for closure"}],"success":true} ',
              200));
    ...
    test("accept task testing  ", () async {
      ...
      when(client.post(headers: {
        ...
        "status": "2",
          ...
          .thenAnswer((_) async => http.Response(
              ' {"results": { "current_Task_status": 2 },"success": true}',
              200));

      var response = await dashboardService.updateStatus(
          id: taskId, status: "2", token: mockToken);
    ...
    test("start task testing  ", () async {
      ...
      var response = await dashboardService.updateStatus(
          id: taskId, status: "3", token: mockToken);
    ...
    test("start task testing exception  ", () async {
      ...
      try {
        await dashboardService.updateStatus(
            id: taskId, status: "", token: mockToken);
      } catch (e) {
        expect(e.toString(),
            '{message: "status" must be a number, success: false, results: []}');
      }
    });
    ...
    test(" request for closure task testing  ", () async {
      ...
      var response = await dashboardService.updateStatus(
          id: taskId, status: "6", token: mockToken);
