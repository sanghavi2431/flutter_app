...
void main() {
  ...
  setUp(() async {
    ...
    service = SelfieService(
        dio: DioClient(dio)); // Replace with your actual service class
  });
  ...
  test('Upload selfie successfully', () async {
    ...
    when(client.post(headers: {
      ...
      "image": file,
        ...
        .thenAnswer((_) async => http.Response(
            '{"results": "Image successfully uploaded!","success": true}',
            200));
    ...
    final result = await service.uploadSelfie(
        type: type, image: file, id: reqId, remarks: remarks, token: mockToken);
  ...
  test('Upload selfie  fail ', () async {
    ...
    try {
      final result = await service.uploadSelfie(
          type: type, image: file, id: "", remarks: remarks, token: mockToken);

      expect(result, throwsException);
    } catch (e) {
      expect(e.toString(),
          '{message: "id" must be a number, success: false, results: []}');
    }
