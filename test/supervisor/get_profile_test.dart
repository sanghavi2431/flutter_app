  ...
  group("get proflie api testing ", () {
    ...
    test(
      ...
      () async {
        ...
        try {
          var response = await profileService.getProfile(
              supervisorId: decodedToken!["0"], token: mockToken);

          expect(response, throwsException);
        } catch (e) {
          expect(
              e.toString(), 'type \'Null\' is not a subtype of type \'int\'');
        }
      },
    );
  });
