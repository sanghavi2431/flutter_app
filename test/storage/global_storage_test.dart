...
void main() {
  ...
  group('Profile Tests', () {
    ...
    test('save profile with empty name throws error', () {
      expect(() => globalStorage.saveProfile(profileName: ''),
          throwsA('Access Token is empty'));
    });
  ...
  group('Profile Image Tests', () {
    ...
    test('save profile image with empty string throws error', () {
      expect(() => globalStorage.saveProfileImg(profileimg: ''),
          throwsA('Access Token is empty'));
    });
  ...
  group('Shift Tests', () {
    ...
    test('save shift with empty string throws error', () {
      expect(() => globalStorage.saveShift(shift: ''),
          throwsA('Access Token is empty'));
    });
  ...
  group('Mobile Number Tests', () {
    ...
    test('saving empty mobile number should throw error', () {
      expect(() => globalStorage.saveMobileNumber(accessMobileNumber: ''),
  ...
  group('Location Tests', () {
    ...
    test('saving empty location should throw error', () {
      expect(() => globalStorage.saveLocation(accessLocation: ''),
          throwsA('Location is empty'));
    });
  ...
  group('Latitude and Longitude Tests', () {
    ...
    test('saving empty latitude should throw error', () {
      expect(() => globalStorage.saveLattitude(accessLatitude: ''),
          throwsA('Latitude is empty'));
    });
    ...
    test('saving empty longitude should throw error', () {
      expect(() => globalStorage.saveLongitude(accessLongitude: ''),
          throwsA('Latitude is empty'));
    });
  ...
  group('Date and Time Tests', () {
    ...
    test('saving empty current time should throw error', () {
      expect(() => globalStorage.saveTime(accessTime: ''),
          throwsA('Time is empty'));
    });
