            ...
            children: [
              ...
              BlocConsumer<SubcriptionBloc, SubscriptionState>(
                ...
                builder: (context, state) {
                  ...
                  return inactiveFacilities.isEmpty
                      ? const SizedBox()
                        ...
                        children: [
                          ...
                          GestureDetector(
                              onTap: () {
                                ...
                                if (planModel.results!.plans![selectedIndex]
                                            .name ==
                                        "PREMIUM" &&
                                    results[index].planName! == "CLASSIC") {
                                  showRadioOptionDialog(context);
                                  ...
                                  //   )
                                  // );
                                } else if (results[index].planName! ==
                                        "PREMIUM" &&
                                    results[index].subscriptionStatus! ==
                                        "inactive") {
                              ...
                              child: CustomImageProvider(
                                width: 34,
                                height: 34,
                                image: planModel.results!.plans![selectedIndex]
                                                .name ==
                                            "PREMIUM" &&
                                        results[index].planName! == "CLASSIC"
              ...
              content: Column(
                ...
                children: [
                  RadioListTile<String>(
                    title: Text(
                      'Renew Membership after the current Membership gets over',
                    ...
                    onChanged: (value) {
                      ...
                      insertOnlyOneAtZero(PlanReqModel(
                          ...
                          qty: 1,
                          facilityId:
                              inactiveFacilities[selectedFacility].facilityId,
                          isRenewal: true,
                  ...
                  isSelected
                      ? const Text(
                          "Please select Above option to renew membership",
                  ...
                  GestureDetector(
                    onTap: () {
                      isSelected = selectedOption.isEmpty ? true : false;
                      setState(() {});
              ...
              children: <Widget>[
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    // }
                    print("Aarati ${inactiveFacilities[selectedFacility]} , ${planModel.results!.plans![selectedIndex].name} , ${widget.isfromOnboard}");
                    if (planModel.results!.plans![selectedIndex].name ==
                            "PREMIUM" &&
                        widget.fromTabbar == false) {
                      Navigator.of(context).pop();
                      Navigator.of(context).pop();
                      Navigator.of(context)
                          .pop(inactiveFacilities[selectedFacility]);
                      if (widget.isfromOnboard) {
                        Navigator.of(context)
                            .pop(inactiveFacilities[selectedFacility]);
                        //  Navigator.of(context).pop();
