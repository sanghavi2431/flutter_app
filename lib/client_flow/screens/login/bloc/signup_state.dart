...
class UserRole extends SignUpState {
  UserRoleModel? userRoleModel;
  UserRole({this.userRoleModel});

  @override
  List<Object> get props => [userRoleModel!];
}
...
class LoginOTPSent extends SignUpState {
  // LoginOTPSent({});
  @override
  List<Object> get props => [];
}

class LoginOTPVerified extends SignUpState {
  @override
  List<Object> get props => [];
}
...
class LoginGetDataSuccess extends SignUpState {
