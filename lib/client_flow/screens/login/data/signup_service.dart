...
class SignupService {
  ...
  Future<bool> signUp({
    ...
    try {
      ...
      var response = await dio.post(
        options: Options(
          headers: {"x-api-key": "k45GQj8FtKt0NR074UfFyvCEPAfJBzxY"},
        ),
  ...
  Future<VerfiyOtpModel> verifyOtp({
    ...
    try {
      var response = await dio.post(
        ...
        data: {"request_id": requestId, "otp": otp},
      );
  ...
  Future<UserRoleModel> getUserRole({
