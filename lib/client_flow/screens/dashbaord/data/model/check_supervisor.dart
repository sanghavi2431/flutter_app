...
CheckSupervisorModel checkSupervisorFromJson(String str) =>
    CheckSupervisorModel.fromJson(json.decode(str));

String checkSupervisorToJson(CheckSupervisorModel data) =>
...
class CheckSupervisorModel {
  ...
  factory CheckSupervisorModel.fromJson(Map<String, dynamic> json) =>
      CheckSupervisorModel(
