...
DeleteFacilityModel deleteFacilityModelFromJson(String str) =>
    DeleteFacilityModel.fromJson(json.decode(str));

String deleteFacilityModelToJson(DeleteFacilityModel data) =>
