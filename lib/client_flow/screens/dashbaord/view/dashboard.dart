...
import 'package:woloo_smart_hygiene/client_flow/screens/dashbaord/view/widget/reward_popup.dart';
...
class ClientDashboard extends StatefulWidget {
  int? dashIndex;
  String? popUpMsg;
  ClientDashboard({super.key, this.dashIndex, this.popUpMsg});
...
//   ];
  ...
  void didUpdateWidget(covariant ClientDashboard oldWidget) {
    ...
    print("prodfsd $roleId");
    // dashBoardBloc.a dd(ClientEvent(id: decodedToken!["id"]));
  }
  ...
  Widget build(BuildContext context) {
    ...
    /// Logout Red screen issue fixed

    final some = globalStorage.getClientToken();

    if (some.isEmpty) {
      return const SizedBox(); // navigate to login
    }
