                      ...
                      children: <Widget>[
                          ...
                          child: Container(
                            ...
                            child: MultiselectDropDownDialog(
                              ...
                              itemAsString: (TaskDropdownModel item) {
                                return "${item.facilityName}   ${item.requiredTime} min";
                              },
                              validator: (value) {
                                print("slecrte $value");
                                value == [] ? "Please select tasks" : null;
                              },
                              ...
                              onChanged: (List<TaskDropdownModel> i) {
                                ...
                                } else if (i.isNotEmpty && len! < i.length) {
                                  listTime =
                                      i.map((e) => e.requiredTime).toList();
                                  estimatedTime =
                                      listTime.reduce((a, b) => a! - b!);
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Obx(
                                  () => SizedBox(
                                    height: dashController.taskStartTime.isEmpty
                                        ? 0
                                        : 200,
                                    child: ListView.builder(
                                      shrinkWrap: true,
                                      itemCount:
                                          dashController.taskStartTime.length,
                                      itemBuilder: (context, index) {
                                        return ListTile(
                                          trailing: IconButton(
                                            onPressed: () {
                                              dashController.taskStartTime
                                                  .removeAt(index);
                                              dashController.taskEndTime
                                                  .removeAt(index);
                        ...
                        GestureDetector(
                            onTap: () {
                              ...
                              if (shiftTime != null &&
                                  dashController.taskStartTime.isNotEmpty &&
                                  estimatedTime != null) {
