...
class _FacilityBottomsheetState extends State<FacilityBottomsheet> {
  ...
  void initState() {
    ...
    // ✅ Get roleId from global storage
    roleId = globalStorage.getRoleId();

    // ✅ If roleId is 16, call IoT API
    ...
    return BlocListener<IotBloc, IotState>(
        listener: (context, state) {
          ...
          if (state is HostDetailsSuccess) {
            ...
            print("aarati data ${state.hostDetailsHome.results!.title}");

            setState(() {
              _hostDetailsData = state.hostDetailsHome;
              widget.facilityController?.text = state.hostDetailsHome.results!.title!;
            });
          }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Center(
                    child: Text(
                      DashboardConst.listYourFacility,
                      ...
                      children: List.generate(facility.length, (index) {
                        return GestureDetector(
                          onTap: () {
                            ...
                            facility[selectedIndex].title == "Other"
                                ? isSelected = true
                                : isSelected = false;
