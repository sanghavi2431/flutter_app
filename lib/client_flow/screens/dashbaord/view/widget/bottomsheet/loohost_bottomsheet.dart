...
class _LoohostBottomsheetState extends State<LoohostBottomsheet> {
  ...
  List<TaskDropdownModel> hostList = [
    TaskDropdownModel(id: 1, facilityName: "Host 1"),
    TaskDropdownModel(id: 1, facilityName: "Host 2")
  ];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Text(
              ClientConstant.becomeHostTitle,
          ...
          Padding(
            ...
            child: DropDownDialog(
              ...
              itemAsString: (FacilityDropdownModel item) => item.facilityName,
              ...
              validator: (value) =>
                  value == null ? "Please select facility" : null,
            ),
          ),
          const SizedBox(
            height: 10,
          ...
          Padding(
            ...
            child: GestureDetector(
                ...
                child: const Custombutton(
                    text: ClientConstant.next, width: double.infinity)),
          ),
          const SizedBox(
            height: 20,
          ),
