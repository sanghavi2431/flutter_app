...
class GetSupervisor extends DashboardState {
  GetSupervisorListModel? getSupervisorModel;
  GetSupervisor({this.getSupervisorModel});
  @override
  List<Object> get props => [getSupervisorModel!];
}
...
class HostDetailsSuccess extends DashboardState {
...
class FacilityType extends DashboardState {
  FacilityTypeModel?  facilityTypeModel;

  FacilityType({this.facilityTypeModel});

  @override
  List<Object> get props => [facilityTypeModel!];
}

class GetLanguages extends DashboardState {
  LanguageModel? languageModel;

  GetLanguages({this.languageModel});
...
class ClientSetupSuccess extends DashboardState {
  final ClientFullSetupResponse response;

  ClientSetupSuccess(this.response);
