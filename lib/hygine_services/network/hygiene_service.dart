...
import '../model/hygiene_categories.dart' as hygieneCat;
...
class HygieneServiceApi {
  ...
  Future<hygieneCat.HygieneCategories> getHygieneCategories() async {
    try {
      var response = await dio.get(
        "https://staging-store.woloo.in/store/products?fields=*variants.calculated_price,variants.inventory_quantity,*categories,metadata&region_id=reg_01JPH693TAM20TXZEJNBJ5QBV4",
        options: Options(
          headers: {
            'x-publishable-api-key':
                'pk_67ce4e90f35529f44006d2a95b330dbabbe576e43d3fd06021ca656ee00806cf',
      ...
      return hygieneCat.HygieneCategories.fromJson(response);
    } catch (e) {
      debugPrint("Error in IOT service: $e");
      rethrow;
    }
