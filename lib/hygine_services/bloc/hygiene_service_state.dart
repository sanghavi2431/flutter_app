...
class HygieneCategorySuccess extends HygieneServiceState {
  final cat.HygieneCategories serviceCategories;
  const HygieneCategorySuccess({required this.serviceCategories});
  @override
  List<Object> get props => [];
}
