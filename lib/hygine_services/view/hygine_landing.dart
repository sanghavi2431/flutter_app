...
import '../model/hygiene_categories.dart' as categoryModel;
...
class _HygieneServicesScreenState extends State<HygieneServicesScreen> {
  ...
  categoryModel.HygieneCategories? _hygieneCategories;

  @override
  void initState() {
    _hygieneServiceBloc.add(HygieneServiceReq());
    _hygieneServiceBloc.add(GetCategory());
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocConsumer(
        ...
        listener: (context, state) {
          ...
          if (state is HygieneCategorySuccess) {
            EasyLoading.dismiss();
            setState(() {
              _hygieneCategories = state.serviceCategories;
              print(_hygieneCategories);
              _isDataLoaded = true;
            });
          }
...
//   final hygiene.Product category;
