...
//CHANGE FOR STAGING TO LIVE
  // static var BASE_URL = 'https://staging-api.woloo.in'; // QA
 static var BASE_URL = 'https://api.woloo.in'; // Production
  //static var BASE_URL = 'http://35.207.249.78';
 // static var BASE_URL = 'http://34.180.63.101';

  //CHANGE FOR STAGING TO LIVE
 // static var IMAGE_BASE_URL ='https://woloo-stagging.s3.ap-south-1.amazonaws.com/';
   static var IMAGE_BASE_URL = 'https://woloo-prod.s3.ap-south-1.amazonaws.com/';
  //static var IMAGE_BASE_URL = 'https://storage.googleapis.com/woloo-prod/';

  //CHANGE FOR STAGING TO LIVE
  static var RAZORPAY_KEY = "rzp_live_A0MkofC7Jj2xXK";
  //static var RAZORPAY_KEY ="rzp_test_ZIlhyKgx2C38vT";

  static var GOOGLE_API_KEY = "AIzaSyCkPmUz4UlRdzcKG9gniW9Qfrgzsjhnb_4" ;
...
//---------------------------------------------------------
  ...
  static var GET_USER_COINS = "$BASE_URL/api/whms/clients/getRewardsPoints";

  static var GET_ALL_FACILITY = "$BASE_URL/api/whms/facilities/getFacilities";

  static var GET_HOST_DETAILS = "$BASE_URL/api/wolooHost/byId";
  ...
  static var APP_CONFIG = '$BASE_URL/api/whms/clients/appconfig';

  static var GET_USER_ROLE = '$BASE_URL/api/whms/clients/getLoginUserRole';

  static var GET_PROFILE = '$BASE_URL/api/wolooGuest/byId';

  static var GET_REFERRAL_COINS = "$BASE_URL/api/wolooHost/user_coins";

  static var GET_HOST_DASHBOARD_DATA =
      "$BASE_URL/api/wolooHost/hostDashboardData";

  static var FACILITY_TYPE = "$BASE_URL/api/whms/facilities/facilityType";

  static var GET_LANGUAGES = "$BASE_URL/api/whms/users/getLanguages";

  static var CHECK_MOBILE = "$BASE_URL/api/whms/users/checkMobile";
  static var CLIENT_FULL_SETUP = "$BASE_URL/api/whms/clients/client-full-setup";
...
//'https://staging-store.woloo.in/store/regions'
  ...
  static var PRODUCT_COLLECTIONS =
      '$AUTH_BASE_URL/store/products?fields=*variants.calculated_price,+variants.inventory_quantity,*categories&region_id=reg_01JPH693TAM20TXZEJNBJ5QBV4';
  ...
  static var GET_IOT_REVIEWS = '$BASE_URL/api/whms/feedback/ratingReviewGraph';
