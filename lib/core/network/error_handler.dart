...
class ResponseMessage {
  ...
  static const String noContent =
      AppError.success; // success with no data (no content)
  static const String badRequest =
      AppError.strBadRequestError; // failure, API rejected request
  static const String unauthorised =
      AppError.strUnauthorizedError; // failure, user is not authorised
  static const String forbidden =
      AppError.strForbiddenError; //  failure, API rejected request
  static const String internalServerError =
      AppError.strInternalServerError; // failure, crash in server side
  static const String notFound =
      AppError.strNotFoundError; // failure, crash in server side
