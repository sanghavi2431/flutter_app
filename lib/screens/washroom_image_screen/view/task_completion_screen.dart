...
class TaskCompletionScreen extends StatefulWidget {
  ...
  final bool? isTaskImageRequired;

  const TaskCompletionScreen(
      {super.key, required this.allocationId, this.isTaskImageRequired});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(TaskCompletionScreenConstants.TITLE_TEXT.tr(),
                                              ...
                                              onTap: () async {
                                                Navigator.of(context)
                                                  ...
                                                  builder: (context) =>
                                                    ...
                                                    captureImage: (val) {
                                                      _file1 = val;
                                                      // Remove old file if exists before adding new one
                                                      if (_file1 != null) {
                                              ...
                                              children: [
                                                ...
                                                Positioned(
                                                  ...
                                                  child: GestureDetector(
                                                    onTap: () {
                                                      // Remove from fileList before removing image
                                                      if (_file1 != null) {
                                                        fileList.removeWhere(
                                                            (file) =>
                                                                file.path ==
                                              ...
                                              children: [
                                                ...
                                                Positioned(
                                                  ...
                                                  child: GestureDetector(
                                                    onTap: () {
                                                      // Remove from fileList before removing image
                                                      // Note: _file3 is used for both bloc2 and bloc3
                                                      if (_file3 != null) {
                                                        fileList.removeWhere(
                                                            (file) =>
                                                                file.path ==
                    ...
                    Padding(
                      ...
                      child: Text(TaskCompletionScreenConstants.REMARKS.tr(),
                    ...
                    Padding(
                      ...
                      child: WhiteButtonWidget(
                        ...
                        onTap: () {
                          ...
                          if (widget.isTaskImageRequired == true &&
                              fileList.isEmpty) {
                            showDialog(
                              context: context,
