...
class TaskListService {
  ...
  Future<TaskListModel> getAllTasks({required int id, String? token}) async {
    try {
      ...
      String acceptLanguage =
          languageCodes.isNotEmpty ? languageCodes.first : 'en';
      if (kDebugMode) {
        print("getAllTasks - Language codes from storage: $languageCodes");
        print("getAllTasks - Using accept-language: $acceptLanguage");
      }
      ...
      var response = await dio.get(
        ...
        options: token != null
            ...
            : Options(
                extra: {"auth": true},
                // accept-language will be added by AuthInterceptor
              ),
        queryParameters: {
          "id": id,
        },
  ...
  Future<String> submitTask(
      {required CreateTaskModel createTaskModel, String? token}) async {
    try {
  ...
  Future<String> updateStatus(
      {required String id, required String status, String? token}) async {
    try {
      var response = await dio.post(
