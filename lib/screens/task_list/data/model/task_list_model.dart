...
class Tasks {
  Tasks({this.id, this.taskId, this.taskName, this.status, this.translatedTaskName});
  ...
  Tasks.fromJson(dynamic json) {
    ...
    translatedTaskName = json['translated_task_names']?.toString();
  }
  String? id;
  String? taskId;
  String? taskName;
  String? status;
  String? translatedTaskName;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['status'] = status;
    map['translated_task_names'] = translatedTaskName;
    return map;
  }
}
