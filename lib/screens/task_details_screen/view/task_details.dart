    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Text(MyTaskListConstants.APP_BAR.tr(),
      ...
      body: SafeArea(
        child: BlocConsumer(
            ...
            listener: (context, state) {
              ...
              if (state is UpdateStatusSuccessful) {
                ...
                _supervisorDashboardBloc
                    .add(const GetSupervisorDashboardData());
                // state.
                EasyLoading.dismiss();
            ...
            builder: (context, state) {
              ...
              } else if (state is GetSubmittedTasksSuccess) {
                ...
                return
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(MyTaskDetailsScreenConstants.TITLE.tr(),
                          textAlign: TextAlign.start,
                          style: AppTextStyle.font24.copyWith(
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Center(
                                      child: Text(
                                          MydashboardScreenConstants.REJECT
                                              .tr(),
                                    ...
                                    child: Center(
                                      child: Text(
                                          MyTaskDetailsScreenConstants
                                              .APPROVE_BUTTON
                                              .tr(),
                                          style: AppTextStyle.font16w6.copyWith(
                                            color: AppColors.titleColor,
                                          )
                                          //  TextStyle(
                                          //   color: AppColors.black,
              ...
              } else if (state is GetSubmittedTasksError) {
                return CustomErrorWidget(error: state.error.message);
              } else if (state is UpdateStatusLoading) {
                EasyLoading.show(
                    status: MydashboardScreenConstants.LOADING_TOAST.tr());
              } else if (state is UpdateStatusSuccessful) {
                _supervisorDashboardBloc
                    .add(const GetSupervisorDashboardData());
              }
