...
class _JanitorSlotState extends State<JanitorSlot> {
  ...
  void initState() {
    ...
    assignBloc.add(GetJanitorTask(id: widget.id));
                ...
                BlocConsumer(
                    listener: (context, state) {
                      if (state is AssignTaskDataSuccess) {
                        ...
                        //  Navigator.of(context).pop();
                        _supervisorDashboardBloc
                            .add(const event.GetSupervisorDashboardData());
                      }
                    ...
                    builder: (context, state) {
                      if (state is JanitorTaskLoading) {
                        EasyLoading.show(
                            status:
                                MydashboardScreenConstants.LOADING_TOAST.tr());
                      } else if (state is GetJanitorTaskError) {
                        return CustomErrorWidget(error: state.error.message);
                      } else if (state is GetJanitorTaskDataSuccess) {
                        EasyLoading.dismiss();
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      AssignScreenConstants.UPDATE_TASK.tr(),
                    ...
                    Text(
                      AssignScreenConstants.TASK_NAME.tr(),
                    ...
                    Text(
                      AssignScreenConstants.START_TIME.tr(),
                      style: AppTextStyle.font13w6,
                    ),
                    SizedBox(
                      height: 8.h,
                      ...
                      child: TextFormField(
                        onTap: () async {
                          ...
                          final newDateTime = dateTime
                              .add(Duration(minutes: widget.estimatedTime!));
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return AssignScreenConstants.START_TIME_VALIDATION
                                .tr();
                          }
                    ...
                    Text(
                      AssignScreenConstants.END_TIME.tr(),
                      style: AppTextStyle.font13w6,
                    ),
                    SizedBox(
                      height: 8.h,
                    ...
                    InkWell(
                      onTap: () {
                        // Navigator.of(context).pop();
                        // Navigator.of(context).pop();
                        print("task tekd ${widget.taskTemplateId}");
                        if (formKey.currentState!.validate()) {
                          assignBloc.add(AssignTask(
                              ...
                              taskTemplateId: widget.taskTemplateId));
                        }
                      },
                      child: Container(
                        height: 40,
