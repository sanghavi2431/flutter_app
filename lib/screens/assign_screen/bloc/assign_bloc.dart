...
class AssignBloc extends Bloc<AssignEvent, AssignState> {
  final AssignService assignService = AssignService(dio: GetIt.instance());
  ...
  FutureOr<void> _mapGetJanitorListState(
    ...
    try {
      ...
      // dashController.mapGetDashboardToState();
      var data =
          await assignService.getanitorListByFacilityId(event.facilityId);
