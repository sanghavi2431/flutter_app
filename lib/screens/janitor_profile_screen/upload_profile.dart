...
class UplopadProfile extends StatefulWidget {
  ...
  const UplopadProfile({super.key, this.capture
                ...
                Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child:
                          Text(MySelfieScreenConstants.UPLOAD_TITLE_TEXT.tr(),
                    ...
                    Center(
                      child: Padding(
                        ...
                        child: Text(MySelfieScreenConstants.TITLE_SUBTEXT.tr(),
                            maxLines: 2,
                            ...
                            child: WhiteButtonWidget(
                              ...
                              onTap: () {
                                ...
                                selfieBloc.add(UploadSelfie(
                                  type:
                                      MySelfieScreenConstants.IMAGE_TYPE_UPLOAD,
                                  image: _file!,
                                  id: decodedToken!["id"],
