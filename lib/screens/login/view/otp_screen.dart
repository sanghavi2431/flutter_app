...
//     _tokenStream.listen(setToken);
  ...
  void didChangeDependencies() {
    ...
    if (codes != null && codes.isNotEmpty) {
      ...
      if (locale != null && context.locale.languageCode != locale.languageCode) {
        debugPrint("OTP Screen (Janitor) - Setting locale in didChangeDependencies: ${locale.languageCode}");
                ...
                BlocListener<SignupBloc, SignUpState>(
                  ...
                  listener: (context, state) async {
                    ...
                    if (state is LoginOTPVerified) {
                      ...
                      // Note: Locale update is handled in didChangeDependencies() after EasyLocalization is ready

                      EasyLoading.dismiss();
                      
                      // Navigate after locale is set
                      if (roleId == 1) {
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      print("object $_pin ");
                      if (_pin.isNotEmpty) {
                        widget.loginBloc.add(VerifyOTPEvent(
                          otp: _pin,
                        ));
                      }
                      if (_pin.isEmpty) {
