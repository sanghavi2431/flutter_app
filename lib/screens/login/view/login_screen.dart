...
import 'package:woloo_smart_hygiene/client_flow/screens/login/bloc/signup_event.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          // widget.type == null ? BackButton() : SizedBox(),
          //  backgroundColor: AppColors.backgroundColor,
        ),
                    ...
                    builder: (context, state) {
                      return GestureDetector(
                        onTap: () async {
                         ...
                         var storedMobNo = globalStorage.saveMobileNumber(accessMobileNumber: controller.text);

                          debugPrint("Mobile no. to LS -> $storedMobNo");
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      title: Text(
                          key: ValueKey(_languages[index]), _languages[index]),
