...
class AssignSuccefully extends StatefulWidget {
  ...
  const AssignSuccefully(
      {super.key, required this.assignTask, required this.janitorName});
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
                "Successfully assign ${widget.assignTask.length} tasks to ${widget.janitorName}",
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(MyFacilityListConstants.GOBACK.tr(),
                      textAlign: TextAlign.center,
