              ...
              : RefreshIndicator(
                  onRefresh: () {
                    return Future.delayed(
                      ...
                      () {
                        _issueListBloc
                            .add(GetAllIssues(supervisorId: supervisorId));
                      },
                    );
                  },
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                          ...
                                          child: _data[index]
                                              ...
                                              ? ClipRRect(
                                                  ...
                                                  child: CustomImageProvider(
                                                    image:
                                                        "${_data[index].baseUrl}/${_data[index].profileImage!.replaceAll("[", "").replaceAll("]", "").replaceAll('"', '')}",
                                                    width: 60,
                                                    height: 60,
                                                  ),
                                                )
                                        ...
                                        SizedBox(height: 5.h),
                                        Text(" ${_data[index].janitorName}",
                                            overflow: TextOverflow.ellipsis,
                                            maxLines: 2,
                                            style: AppTextStyle.font12.copyWith(
                                              color:
                                                  AppColors.clusterTitleColor,
                                            )
                                            //  TextStyle(
                                            //   color: AppColors.clusterTitleColor,
                                            //   fontSize: 12.sp,
