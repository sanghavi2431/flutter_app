    ...
    return Container(
      ...
      DropdownSearch<T>(
        ...
        compareFn: (item1, item2) {
           ...
           return (item1 as ClusterDropdownModel).clusterId ==
         (item2 as ClusterDropdownModel).clusterId;
        },
            ...
            ? PopupProps.menu(
                ...
                searchFieldProps: TextFieldProps(
                  decoration: InputDecoration(
                    ...
                    contentPadding:
                        EdgeInsets.only(top: 20.w, left: 10.w, right: 10.w),
