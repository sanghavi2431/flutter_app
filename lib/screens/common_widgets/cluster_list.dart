  ...
  Widget build(BuildContext context) {
    return BlocConsumer(
        ...
        builder: (context, state) {
          ...
          } else if (state is ClusterListError) {
            EasyLoading.dismiss();
            return CustomErrorWidget(error: state.error.message);
          } else if (state is ClusterListSuccess) {
            EasyLoading.dismiss();
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    color:
                                                        const Color(0xff76E16D),
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            25.r),
                                                  ),
                                                  child: Text(
                                                      "Total Tasks: ${_search[index].totalTasks.toString()}"),
                                                ),
                                                SizedBox(
                                                  height: 10.h,
                                                ),
                                                Container(
                                                  ...
                                                  child: Text(
                                                      "Pending Tasks:  ${_search[index].pendingTasks.toString()}"),
                                                )
                                              ],
                                            ),
                                          ],
