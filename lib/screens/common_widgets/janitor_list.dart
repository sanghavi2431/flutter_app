...
class _JanitorListWidgetState extends State<JanitorListWidget> {
  ...
  void initState() {
    ...
    debugPrint(
        " from dash boardassign ment ${widget.isFromDashboardAssignment}");
        ...
        builder: (context, state) {
          ...
          if (state is JanitorListLoading) {
            ...
            if (state.fromReassign) {
              ...
              _janitorListBloc.add(const ReassignTask(
                  isRejected: false,
                  id: [],
                  janitorId: '',
                  fromReassign: false));
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: _search[index]
                                                    ...
                                                    ? Text(" ")
                                                    : Text(
                                                        " Gender :  ${_search[index].gender!.substring(0, 1)}"),
                                              ),
                                              const SizedBox(
                                                width: 8,
                                              ),
                                              Container(
                                                ...
                                                child: Text(
                                                    " Cluster No.: ${_search[index].clusterId}"),
                                              ),
                                            ],
                                          ),
                                          if (widget
                                            ...
                                            child: _search[index]
                                                ...
                                                ? ClipRRect(
                                                    ...
                                                    child: CustomImageProvider(
                                                      image:
                                                          "${_search[index].baseUrl}/${_search[index].profileImage!.replaceAll("[", "").replaceAll("]", "").replaceAll('"', '')}",
                                                    ),
                                                  )
                                                : const Icon(
