  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: AppColors.white,
        leadingWidth: widget.isFromDashboard ? 15 : 100,
        title: widget.isFromDashboard
            ? Text(MyJanitorsListScreenConstants.TITLE_TEXT.tr(),
          ...
          children: [
            ...
            widget.isFromCluster || widget.isFromDashboardAssignment
                ? Padding(
                    ...
                    child: Text(MyJanitorsListScreenConstants.TITLE_TEXT.tr(),
                        style: AppTextStyle.font24bold.copyWith(
                          color: AppColors.black,
                        )
                        // TextStyle(
                ...
                onTapItem: (JanitorListModel data) async {
                  if (widget.isFromCluster && data.isPresent == true) {
                    await Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => BlocProvider<JanitorListBloc>(
