...
class DashboardModelClass {
  ...
  DashboardModelClass.fromJson(dynamic json) {
    ...
    requiredTaskImage = json['requires_task_image'];
  ...
  Map<String, dynamic> toJson() {
    ...
    map['status'] = status;
    map['requires_task_image'] = requiredTaskImage;
    map['translated_status'] = translatedStatus;
    return map;
  }
}
