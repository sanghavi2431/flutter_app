...
import '../../../task_list/bloc/tasklist_bloc.dart';
import '../../../task_list/bloc/tasklist_event.dart';
import '../../../task_list/bloc/tasklist_state.dart';
                  ...
                  child: Padding(
                    ...
                    child: ListBody(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          widget.filter[selectedIindex!].templateName!,
                          style: AppTextStyle.font16bold.copyWith(fontSize: 16),
                        ),
                        SizedBox(
                          height: 20.h,
                        ),
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final janitor =
                                  state.data.tasks![index].translatedTaskName ??
                                      state.data.tasks![index].taskName;
                              return Padding(
                        ...
                        GestureDetector(
                          ...
                          child: Custombutton(
                              height: 30.h, text: "okay".tr(), width: 320.w),
                        ),
                        SizedBox(
                          height: 10.h,
                        ),
                          ...
                          cardBuilder: (
                            ...
                            return Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: widget.filter[index].status ==
                                        "Completed"
                                    ? Container(
                                        height: 180.h,
                                        padding: EdgeInsets.symmetric(
                                                    ...
                                                    children: [
                                                      ...
                                                      InkWell(
                                                        onTap: () async {
                                                          ...
                                                          debugPrint(
                                                              "afasdfasfsadf${widget.filter[index].taskAllocationId}");
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  SizedBox(
                                                                    width: 80.w,
                                                                    child: Text(
                                                                        MydashboardScreenConstants.Rquest_TASK
                                                                            .tr(),
                                                                        maxLines:
                                                                            2,
                                                                        softWrap:
                        ...
                        children: [
                          Padding(
                            ...
                            child: swipeRightButton(
                                controller, widget.filter.length),
                          ),
                          Padding(
                            padding: const EdgeInsets.only(right: 16),
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Center(
                                child: Text(
                                  "${widget.filter.first.translatedStatus} ${"taskColon".tr()} ${widget.filter.length}",
                                  textAlign: TextAlign.center,
