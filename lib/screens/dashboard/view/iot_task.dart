      ...
      body: Column(
          ...
          children: [
            ...
            TabBar(
              ...
              isScrollable: true,
              labelStyle: AppTextStyle.font12bold.copyWith(
              ...
              tabs: [
                Tab(
                    icon: TabWidget(
                        title: MydashboardScreenConstants.PENDING_TASK.tr())),
                Tab(
                    icon: TabWidget(
                        title: MydashboardScreenConstants.ACCEPT_TASk.tr())),
                Tab(
                    icon: TabWidget(
                        title: MydashboardScreenConstants.Onging_TASK.tr())),
                Tab(
                    icon: TabWidget(
                        title: MydashboardScreenConstants.Rquest_TASK.tr())),
                Tab(
                    icon: TabWidget(
                        title: MydashboardScreenConstants.COMPLETE_TASK.tr())),
                Tab(
                    icon: TabWidget(
                        title: MydashboardScreenConstants.REJECTED_TASk.tr()))
              ],
            ),
            Expanded(
              ...
              child: TabBarView(
                ...
                children: [
                  DashboardListWidget(
                    tabController: tabController,
                    dataforEmyptyList:
                        EmptyWidgetConstants.PENDING_TASK_ERROR.tr(),
                  ...
                  DashboardListWidget(
                    tabController: tabController,
                    dataforEmyptyList:
                        EmptyWidgetConstants.ACCEPTED_TASK_ERROR.tr(),
                    currentLattitude: widget.lat,
                    currentLongitude: widget.long,
                    filter: widget.filter
                  ...
                  DashboardListWidget(
                    tabController: tabController,
                    dataforEmyptyList:
                        EmptyWidgetConstants.ONGOING_TASK_ERROR.tr(),
                    currentLattitude: widget.lat,
                    currentLongitude: widget.long,
                    filter: widget.filter
                  ...
                  DashboardListWidget(
                    ...
                    currentLongitude: widget.long,
                    filter: widget.filter
                        .where((e) => e.status == "Request for closure")
                        .toList(),
                    dashboardBloc: widget.dashboardBloc,
                    onTapItem: () {},
                  ),
                  DashboardListWidget(
                    ...
                    onTapItem: () {},
                    dataforEmyptyList:
                        EmptyWidgetConstants.COMPELTED_TASK_ERROR.tr(),
                  ),
                  DashboardListWidget(
                    tabController: tabController,
                    currentLattitude: widget.lat,
