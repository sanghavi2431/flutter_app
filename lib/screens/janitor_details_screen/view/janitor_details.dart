              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(MyJanitorsDetailsScreenConstants.APP_BAR.tr(),
                        textAlign: TextAlign.start,
                  ...
                  InkWell(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(MyJanitorProfileScreenConstants.HISTORY.tr(),
                        ...
                        child: widget.profile.isNotEmpty
                            ? ClipRRect(
                                ...
                                child: CustomImageProvider(
                                  image:
                                      "${widget.baseUrl}/${widget.profile.replaceAll("[", "").replaceAll("]", "").replaceAll('"', '')}",
                                ),
                              )
                            : const Icon(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(MyJanitorsDetailsScreenConstants.SHIFT.tr(),
                        style: AppTextStyle.font24bold.copyWith(
                          color: AppColors.black,
                        )
                        //  TextStyle(
                        ...
                        child: Column(
                          children: [
                            ...
                            widget.checkInTime == "Invalid date"
                                ...
                                : Text(widget.checkInTime.split(",").last,
                                    style: AppTextStyle.font20bold.copyWith(
                                      color: AppColors.black,
                                    )
                                    // TextStyle(
                        ...
                        child: Column(
                          children: [
                            ...
                            widget.checkInTime == "Invalid date"
                                ...
                                : Text(widget.checkOutTime.split(",").last,
                                    textAlign: TextAlign.center,
                                    style: AppTextStyle.font20bold.copyWith(
                                      color: AppColors.black,
                                    )
                          ...
                          child: ChoiceChip(
                            ...
                            onSelected: (bool selected) async {
                              ...
                              if (_selectedChipIndex == 0) {
                                ...
                                var startdayformat = DateFormat('yyyy-MM-dd')
                                    .format(results.first!);
                                var enddayformat = DateFormat('yyyy-MM-dd')
                                    .format(results[1]!);
                                _janitorListBloc.add(GetAllJanitors(
                                  endDate: enddayformat,
                                  startDate: startdayformat,
              ...
              BlocBuilder(
                  ...
                  builder: (context, state) {
                    if (state is JanitorListLoading) {
                      ...
                      var temp =
                          janitorData.where((e) => e.id == widget.id).toList();
