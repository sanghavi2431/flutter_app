...
class UpdateAddressSuccess extends B2BStoreState {
  final Addresses addressesData;
  const UpdateAddressSuccess({required this.addressesData});
  @override
  List<Object> get props => [addressesData];
}
...
class CheckInventorySuccess extends B2BStoreState {
  final dynamic inventoryModel;
  const CheckInventorySuccess({required this.inventoryModel});
  @override
...
class AllProductsSuccess extends B2BStoreState {
  final ProductCollections productCollections;
  const AllProductsSuccess({required this.productCollections});

  @override
  List<Object> get props => [productCollections];
}
...
class CheckInventoryError extends B2BStoreState {
  final String error;
  const CheckInventoryError({required this.error});

  @override
  List<Object> get props => [error];
}

class DeliveryPartnersLoading extends B2BStoreState {
  final String message;
  const DeliveryPartnersLoading(
      {this.message = "Loading delivery partners..."});

  @override
  List<Object> get props => [message];
}

class DeliveryPartnersSuccess extends B2BStoreState {
  final DeliveryCodesResponse response;
  const DeliveryPartnersSuccess({required this.response});

  @override
  List<Object> get props => [response];
}

class DeliveryPartnersError extends B2BStoreState {
  final String error;
  const DeliveryPartnersError({required this.error});
