...
class UpdateAddress extends B2BStoreEvent {
  final Addresses addressesData;
  const UpdateAddress({required this.addressesData});
...
class CheckInventory extends B2BStoreEvent {
...
class GetAllProductsEvent extends B2BStoreEvent {
...
class GetCartEvent extends B2BStoreEvent {
  const GetCartEvent();
...
class GetProductsByCategoryEvent extends B2BStoreEvent {
  ...
  final String? sized;
  const GetProductsByCategoryEvent({required this.categoryId, this.sized});

  @override
  List<Object?> get props => [categoryId];
}

class GetDeliveryPartners extends B2BStoreEvent {
  String pincode;

  GetDeliveryPartners(this.pincode);
