...
class Item {
  ...
  final bool requiresShipping; // non-nullable with default
  ...
  final bool isTaxInclusive; // non-nullable with default
  ...
  factory Item.fromJson(Map<String, dynamic> json) => Item(
        ...
        requiresShipping:
            asBool(json["requires_shipping"], defaultValue: false),
        ...
        isTaxInclusive: asBool(json["is_tax_inclusive"], defaultValue: false),
        taxLines: json["tax_lines"] == null
            ? []
            : List<dynamic>.from((json["tax_lines"] as List).map((x) => x)),
        adjustments: json["adjustments"] == null
            ? []
            : List<Adjustment>.from((json["adjustments"] as List)
                .map((x) => Adjustment.fromJson(x))),
        product:
...
class Cart {
  ...
  factory Cart.fromJson(Map<String, dynamic> json) => Cart(
        ...
        shippingMethods: json["shipping_methods"] == null
            ? []
            : List<ShippingMethod>.from((json["shipping_methods"] as List)
        ...
        creditLines: json["credit_lines"] == null
            ? []
            : List<dynamic>.from((json["credit_lines"] as List).map((x) => x)),
        ...
        promotions: json["promotions"] == null
            ? []
            : List<Promotion>.from(
                (json["promotions"] as List).map((x) => Promotion.fromJson(x))),
      );
...
class Customer {
  ...
  factory Customer.fromJson(Map<String, dynamic> json) => Customer(
        id: json["id"],
        email: json["email"],
        groups: List<dynamic>.from((json["groups"] as List).map((x) => x)),
      );
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
        ...
        typeId: json["type_id"],
        categories:
            List<dynamic>.from((json["categories"] as List).map((x) => x)),
        tags: List<dynamic>.from((json["tags"] as List).map((x) => x)),
      );
...
class Region {
  ...
  factory Region.fromJson(Map<String, dynamic> json) => Region(
        ...
        name: json["name"],
        currencyCode: json["currency_code"],
        automaticTaxes: asBool(json["automatic_taxes"], defaultValue: false),
        countries: List<Country>.from(
            (json["countries"] as List).map((x) => Country.fromJson(x))),
      );
...
class Promotion {
  final String? id;
  final String? code;
  final bool isAutomatic; // non-nullable with default
  ...
  factory Promotion.fromJson(Map<String, dynamic> json) => Promotion(
        id: json["id"],
        code: json["code"],
        isAutomatic: asBool(json["is_automatic"], defaultValue: false),
...
class ShippingMethod {
  ...
  factory ShippingMethod.fromJson(Map<String, dynamic> json) => ShippingMethod(
        ...
        adjustments: json["adjustments"] == null
            ? []
            : List<dynamic>.from((json["adjustments"] as List).map((x) => x)),
      );
